...
public abstract class KeyedMapStorage implements MapStorage {
     ...
     *
     * @param key the key identifying the grid storage
     * @param compressionHint a hint for which compression algorithm to use if creating a new storage
     * @return the GridStorage associated with the given key
     */
     ...
     *
     * @param key the key identifying the item storage
     * @param compressionHint a hint for which compression algorithm to use if creating a new storage
     * @return the ItemStorage associated with the given key
     */
